...
<div class="cursor"></div>
  ...
  <nav class="navbar py-1">
    ...
    <h1 class="text-center my-4 py-4">Update Your ToDo List</h1>
    ...
    <div class="container">
      <div class="w-50 m-auto">
        <form action="editaction.php" method="post">
          ...
          <input value="<?php global $title; echo $title?>" class="form-control mb-3" type="text" id="title" name="title" placeholder="Update Your Task" require>
          <label for="description" class="h5">Description:</label>
          <input value="<?php global $description; echo $description?>" class="form-control mb-3" type="text" id="description" name="description" placeholder="Update Your Description" require>
          <input type="hidden" name="id" id="id" value="<?php global $id; echo $id?>">
          <button class="btn btn-success w-20 mx-auto add">Update ToDo</button>
        </form>
    </div>
